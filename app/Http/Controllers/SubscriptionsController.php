...
class SubscriptionsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (! $request->has('drp_start') or ! $request->has('drp_end')) {
            $drp_placeholder = 'Seleccione rango de fechas';
        } else {
    ...
    public function update($id, Request $request)
    {
        ...
        $subscription->updatedBy()->associate(Auth::user());
        $subscription->save();
        flash()->success('Detalles de la suscripción actualizados con éxito');
    ...
    public function cancelSubscription($id)
    {
        ...
        try {
            ...
            DB::rollback();
            flash()->error('Hubo un error al cancelar la suscripción');
    ...
    public function modify($id, Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            flash()->success('Se cambió la suscripción con éxito');

            return redirect(action('MembersController@show', ['id' => $subscription->member_id]));
        } catch (\Exception $e) {
            DB::rollback();
            flash()->error('Ocurrió un error al cambiar la suscripción');
