...
class AclController extends Controller
{
    ...
    public function storeUser(Request $request)
    {
        ...
        flash()->success('Usuario fue creado exitosamente');
    ...
    public function updateUser($id, Request $request)
    {
        ...
        flash()->success('Detalles de usuario fueron actualizados exitosamente');
    ...
    public function deleteUser($id)
    {
        ...
        try {
            ...
            DB::commit();
            flash()->success('Usuario fue eliminado exitosamente');

            return redirect('user');
        } catch (Exception $e) {
            DB::rollback();
            flash()->error('Usuario no fue eliminado exitosamente');
    ...
    public function storeRole(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            flash()->success('Rol fue creado exitosamente');

            return redirect('user/role');
        } catch (Exception $e) {
            DB::rollback();
            flash()->error('Rol no fue creado exitosamente');
    ...
    public function updateRole($id, Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            flash()->success('Rol fue actualizado exitosamente');

            return redirect('user/role');
        } catch (Exception $e) {
            DB::rollback();
            flash()->error('Rol no fue actualizado exitosamente');
    ...
    public function deleteRole($id)
    {
        ...
        try {
            ...
            DB::commit();
            flash()->success('Rol fue eliminado exitosamente');

            return redirect('user/role');
        } catch (Exception $e) {
            DB::rollback();
            flash()->error('Rol no fue eliminado exitosamente');
    ...
    public function storePermission(Request $request)
    {
        ...
        flash()->success('Permiso fue creado exitosamente');
    ...
    public function updatePermission($id, Request $request)
    {
        ...
        flash()->success('Permiso fue actualizado exitosamente');
    ...
    public function deletePermission($id)
    {
        ...
        flash()->success('Permiso fue eliminado exitosamente');
