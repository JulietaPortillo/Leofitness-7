...
@section('content')
    ...
    <div class="rightside bg-grey-100">
        ...
        <div class="page-head bg-grey-100 padding-top-15 no-padding-bottom">
            ...
            <h1 class="page-title no-line-height">Suscripciones Expiradas
                <small>Detalles de todas las suscripciones expiradas</small>
            </h1>
            ...
            <h1 class="font-size-30 text-right color-blue-grey-600 animated fadeInDown total-count pull-right"><span data-toggle="counter" data-start="0"
                ...
                <small class="color-blue-grey-600 display-block margin-top-5 font-size-14">Suscripciones Expiradas</small>
            </h1>
            @endpermission
        </div><!-- / PageHead -->
                    ...
                    <div class="panel no-border ">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 no-padding">
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            {!! Form::select('sort_field',array('created_at' => 'Fecha','plan_name' => 'Nombre del plan'),old('sort_field'),['class' => 'form-control selectpicker show-tick show-menu-arrow', 'id' => 'sort_field']) !!}
                                        </div>
                        ...
                        <div class="panel-body no-padding-top bg-white">
                            @if($allExpired->count() == 0)
                                <h4 class="text-center padding-top-15">Lo sentimos! No se encontrar suscripciones por expirar</h4>
                            @else
                                ...
                                <div class="row">
                                    <div class="col-xs-6">
                                        <div class="gymie_paging_info">
                                            <!-- TO DO -->
                                            Mostrando pagina {{ $allExpired->currentPage() }} de {{ $allExpired->lastPage() }}
                                        </div>
                                    </div>
