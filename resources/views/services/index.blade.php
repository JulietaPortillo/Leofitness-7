    ...
    <div class="rightside bg-grey-100">
        ...
        <div class="page-head bg-grey-100 padding-top-15 no-padding-bottom">
            ...
            <h1 class="page-title no-line-height">Servicios
                ...
                <a href="{{ action('ServicesController@create') }}" class="page-head-btn btn-sm btn-primary active" role="button">Agregar nuevo servicio</a>
                <small>Detalles del servicios </small>
            </h1>
            ...
            <h1 class="font-size-30 text-right color-blue-grey-600 animated fadeInDown total-count pull-right"><span data-toggle="counter" data-start="0"
                ...
                <small class="color-blue-grey-600 display-block margin-top-5 font-size-14">Total de servicios</small>
            </h1>
            @endpermission
            @endpermission
        </div><!-- / PageHead -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel no-border ">
                        <div class="panel-body no-padding-top bg-white">
                            ...
                            @if($services->count() == 0)
                                <h4 class="text-center padding-top-15">Lo sentimos! No se encontraron servicios</h4>
                            @else
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        ...
                                                        <li>
                                                            <a href="#"
                                                               ...
                                                               data-dependency-message="Este servicio esta asociado a uno o mas planes. No se puede eliminar."
