    ...
    <div class="rightside bg-grey-100">
        ...
        <div class="page-head bg-grey-100 padding-top-15 no-padding-bottom">
            ...
            <h1 class="page-title no-line-height">Recibos
                <small>Detalle de todos los recibos sin pagar</small>
            </h1>
            ...
            <h1 class="font-size-30 text-right color-blue-grey-600 animated fadeInDown total-count pull-right"><span data-toggle="counter" data-start="0"
                ...
                <small class="color-blue-grey-600 display-block margin-top-5 font-size-14">Recibos no pagados</small>
            </h1>
            @endpermission
        </div><!-- / PageHead -->
                ...
                <div class="col-lg-12"><!-- Main Col -->
                    <div class="panel no-border ">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 no-padding">
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            {!! Form::select('sort_field',array('created_at' => 'Fecha','invoice_number' => 'Numero de recibo','member_name' => 'Nombre del miembro','total' => 'Monto total','pending_amount' => 'Monto pendiente'),old('sort_field'),['class' => 'form-control selectpicker show-tick show-menu-arrow', 'id' => 'sort_field']) !!}
                                        </div>
                        ...
                        <div class="panel-body bg-white">
                            @if($invoices->count() == 0)
                                <h4 class="text-center padding-top-15">Lo sentimos! No se encontraron recibos sin pagar.</h4>
                            @else
