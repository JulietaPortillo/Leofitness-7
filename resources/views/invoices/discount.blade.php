        ...
        <div class="container-fluid">
            ...
            @if ($errors->any())
                <div class="alert alert-danger">
                    ...
                    <strong>Whoops!</strong> Hubo un error en los datos ingresados.<br><br>
                    <ul>
                ...
                <div class="col-md-12">
                    <div class="panel no-border">
                        <div class="panel-title">
                            <div class="panel-head font-size-20">Ingresar los detalles del descuento</div>
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        {!! Form::label('taxes_amount',sprintf('Porcentaje adicional @ %s %%',Utilities::getSetting('taxes'))) !!}
                                        <div class="input-group">
                                            <div class="input-group-addon"><i class="fa fa-money"></i></div>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select id="discount_percent" name="discount_percent" class="form-control selectpicker show-tick show-menu-arrow">
                                            ...
                                            @endforeach
                                            <option value="custom" {{ ($invoice->discount_percent == "custom" ? "selected" : "") }}>Perzonalido</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        {!! Form::label('discount_note','Razon de decuento') !!}
                    ...
                    <div class="row">
                        <div class="col-sm-2 pull-right">
                            <div class="form-group">
                                {!! Form::submit('Aplicar descuento', ['class' => 'btn btn-primary pull-right']) !!}
                            </div>
                        </div>
                    </div>
