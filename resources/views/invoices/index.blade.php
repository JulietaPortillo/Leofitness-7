    ...
    <div class="rightside bg-grey-100">
        ...
        <div class="page-head bg-grey-100 padding-top-15 no-padding-bottom">
            ...
            <h1 class="page-title no-line-height">Recibos
                <small>Detalles de todos los recibos</small>
            </h1>
            ...
            <h1 class="font-size-30 text-right color-blue-grey-600 animated fadeInDown total-count pull-right"><span data-toggle="counter" data-start="0"
                ...
                <small class="color-blue-grey-600 display-block margin-top-5 font-size-14">Total de recibos</small>
            </h1>
            @endpermission
        </div><!-- / PageHead -->
                ...
                <div class="col-lg-12"><!-- Main Col -->
                    <div class="panel no-border ">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 no-padding">
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            {!! Form::select('sort_field',array('created_at' => 'Fecha','invoice_number' => 'Numero de recibo','member_name' => 'Nombre de miembro','total' => 'Monto total','pending_amount' => 'Pending amount'),old('sort_field'),['class' => 'form-control selectpicker show-tick show-menu-arrow', 'id' => 'sort_field']) !!}
                                        </div>
                        ...
                        <div class="panel-body bg-white">
                            @if($invoices->count() == 0)
                                <h4 class="text-center">Lo sentimos! No se encontraron recibos</h4>
                            @else
