    ...
    <div class="rightside bg-grey-100">
        ...
        <div class="page-head bg-grey-100 padding-top-15 no-padding-bottom">
            ...
            <h1 class="page-title no-line-height">Miembros inactivos
                <small>Detalles de todos los miembros inactivos</small>
            </h1>
                ...
                <div class="col-lg-12"><!-- Main Col -->
                    <div class="panel no-border ">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 no-padding">
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            {!! Form::select('sort_field',array('created_at' => 'Fecha','name' => 'Nombre', 'member_code' => 'Codigo de miembro', 'plan_name' => 'Nombre del plan', 'status' => 'Status'),old('sort_field'),['class' => 'form-control selectpicker show-tick show-menu-arrow', 'id' => 'sort_field']) !!}
                                        </div>
                        ...
                        <div class="panel-body bg-white">
                            ...
                            @if($members->count() == 0)
                                <h4 class="text-center padding-top-15">Lo sentimos! No se encontraron miembros inactivos.</h4>
                            @else
