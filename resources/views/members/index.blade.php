    ...
    <div class="rightside bg-grey-100">
        ...
        <div class="page-head bg-grey-100 padding-top-15 no-padding-bottom">
            ...
            <h1 class="font-size-30 text-right color-blue-grey-600 animated fadeInDown total-count pull-right"><span data-toggle="counter" data-start="0"
                ...
                <small class="color-blue-grey-600 display-block margin-top-5 font-size-14">Total de Miembros</small>
            </h1>
            @endpermission
            @endpermission
        </div><!-- / PageHead -->
                ...
                <div class="col-lg-12"><!-- Main Col -->
                    <div class="panel no-border ">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 no-padding">
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            {!! Form::select('sort_field',array('created_at' => 'Fecha','name' => 'Nombre', 'member_code' => 'Codigo del miembro', 'status' => 'Status'),old('sort_field'),['class' => 'form-control selectpicker show-tick show-menu-arrow', 'id' => 'sort_field']) !!}
                                        </div>
                        ...
                        <div class="panel-body bg-white">
                            ...
                            @if($members->count() == 0)
                                <h4 class="text-center padding-top-15">Lo sentimos! No se encontraron miembros.</h4>
                            @else
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        ...
                                                        <li>
                                                            ...
                                                            <a href="#" class="delete-record" data-delete-url="{{ url('members/'.$member->id.'/archive') }}"
                                                               data-record-id="{{$member->id}}">Eliminar miembros</a>
                                                            @endpermission
                                                        </li>
                                                    </ul>
                                                </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-6">
                                        <div class="gymie_paging_info">
                                            Mostrando pagina {{ $members->currentPage() }} de {{ $members->lastPage() }}
                                        </div>
                                    </div>
                                    <div class="col-xs-6">
