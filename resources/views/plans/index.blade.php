...
@section('content')
    <div class="rightside bg-grey-100">
        ...
        <div class="page-head bg-grey-100 padding-top-15 no-padding-bottom">
            ...
            <h1 class="page-title no-line-height">Plan
                @permission(['manage-gymie','manage-plans','add-plan'])
                <a href="{{ action('PlansController@create') }}" class="page-head-btn btn-sm btn-primary active" role="button">Agregar nuevo plan</a>
            ...
            <h1 class="font-size-30 text-right color-blue-grey-600 animated fadeInDown total-count pull-right">
                ...
                <small class="color-blue-grey-600 display-block margin-top-5 font-size-14">Total de planes</small>
            </h1>
            @endpermission
            @endpermission
        </div><!-- / PageHead -->
                ...
                <div class="col-lg-12">
                    <div class="panel no-border ">
                        <div class="panel-body no-padding-top bg-white">
                            ...
                            @if($plans->count() == 0)
                                <h4 class="text-center padding-top-15">Lo sentimos! No se encontro ningun plan</h4>
                            @else
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        ...
                                                        <li>
                                                            ...
                                                            <a href="#"
                                                               ...
                                                               data-dependency-message="Tienes que eliminar las suscripciones asociadas a este plan antes de eliminarlo."
