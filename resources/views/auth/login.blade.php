...
<div class="wrapper animated fadeInDown">
    <div class="panel overflow-hidden">
        <div class="bg-black padding-40 no-margin-bottom font-size-20 color-white text-center text-uppercase">
            <img src="{{ asset('assets/img/web/LEOFITNESS.png') }}" width="500" height="500" >
        </div>
        @if (count($errors) > 0)
            <div class="alert alert-danger">
                <strong>Whoops!</strong> Hubo errores con tus credenciales.<br><br>
                <ul>
        ...
        <form id="loginform" method="post" action="{{ url('/auth/login') }}">
            ...
            <div class="box-body padding-md">
                ...
                <button type="submit" class="btn btn-dark bg-yellow-a700 padding-10 btn-block color-white"><i class="ion-log-in"></i> Acceder</button>
            </div>
        </form>
        <div class="panel-footer padding-md no-margin no-border bg-grey-900 text-center color-white">&copy; por JP</div>
    </div>
</div>
